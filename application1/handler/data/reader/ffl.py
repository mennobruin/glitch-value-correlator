...
class FrameFileReader(BaseReader):
    ...
    def _get_records(self, file):
        ...
        print(records)
        print(records[(records.gps_end > self.gps_start)])
        print(records[(records.gps_start < self.gps_end)])
        print(records[(records.gps_end > self.gps_start) & (records.gps_start < self.gps_end)])
