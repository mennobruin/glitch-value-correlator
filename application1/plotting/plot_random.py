...
p1, = ax1.plot(h1_cp.xgrid[::-1], 100 * h1.cdf, 'b-', label="% (1-DT)")
ax1.plot(h1_cp.xgrid[::-1], 100 * (1-h2.cdf), 'g-', label="% vetoed")
p2, = ax2.plot(h1_cp.xgrid[::-1], 100 * ((1-h2.cdf) - (1-h1.cdf)), 'r--')
ax1.yaxis.label.set_color(p1.get_color())
ax2.yaxis.label.set_color(p2.get_color())
plt.xlim(min(h1_cp.xgrid), max(h1_cp.xgrid))
plt.xlabel("x")
ax1.set_ylabel("%")
ax2.set_ylabel(r"$E_{\Delta}$")
plt.legend()
plt.title(channel)
