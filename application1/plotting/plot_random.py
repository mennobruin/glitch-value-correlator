...
p1, = ax1.plot(h1_cp.xgrid[::-1], 100 * h1.cdf, 'b-', label="trig",)
p2, = ax2.plot(h1_cp.xgrid[::-1], 100 * (1-h2.cdf), 'g-', label="aux",)
ax1.yaxis.label.set_color(p1.get_color())
ax2.yaxis.label.set_color(p2.get_color())
plt.plot(h1_cp.xgrid[::-1], 100 * ((1-h2.cdf) - (1-h1.cdf)), 'o-', label=r"$E_{\Delta}$")
