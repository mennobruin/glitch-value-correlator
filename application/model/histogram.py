"""
    Histogram with a fixed number of bins that can be merged efficiently. Adapted from EXCAVATor.
"""
...
class Hist:
    ...
    def align(self, other):
        ...
        while (max(self.i_max, other.i_max) - min(self.i_min, other.i_min)) >= self.nbin:
            self.enlarge()
            other.enlarge()
